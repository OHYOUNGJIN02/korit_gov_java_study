...
public class StringProcessorMain {
    public static String excute(String input, StringProcessor processor) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("대문자 문자열: " + excute(testString, toUpper));
        System.out.println("소문자 변환: " + excute(testString, toLower));
        System.out.println("접두사 추가: " +excute(testString, addPrefix));

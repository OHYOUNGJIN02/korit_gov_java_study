...
/*
* @Data
* => getter, setter, toString, RequiredArgs 가 포함되어 있음 */
@Data
...
//    private int data2;
//    private double data3; //Object로 가능하지만 다운캐스팅 필요.
...
* V(Value) Map의 value 또는 제네릭타입의 반환값으로 사용
*
* 재사용성
* 제네릭을 사용하면 다양한 자료형에 대해 하나의 클래스나 메소드를 정의할 수 있어
* 코드의 재사용성을 높이고 중복을 줄일 수 있다.
* 타입 안정성
* 컴파일 시에 타입 체크가 가능하여, 잘못된 타입이 들어갈 수가 없음
